...
public class LevelThree extends LevelParent {
    ...
    private static final String BACKGROUND_IMAGE_NAME = "/com/example/demo/images/background3.png";  // 第三关的背景图
    private static final String NEXT_LEVEL = "Levels.LevelTwo";  // 假设下一关是 Boss 关
